...
use Drupal\dyniva_core\ConfigHelper as Config;
use Drupal\node\Entity\NodeType;
 ...
 */
function dyniva_install_tasks() {
  $tasks = [];

  $tasks['dyniva_prepare_administrator'] = [];
  $tasks['dyniva_set_front_page'] = [];
  $tasks['dyniva_disallow_free_registration'] = [];
  $tasks['dyniva_grant_shortcut_access'] = [];
  $tasks['dyniva_set_default_theme'] = [];
  $tasks['dyniva_set_logo'] = [];
  $tasks['dyniva_alter_frontpage_view'] = [];
 ...
 */
function dyniva_prepare_administrator() {
 ...
 */
function dyniva_set_front_page() {
 ...
 */
function dyniva_disallow_free_registration() {
  Drupal::configFactory()
 ...
 */
function dyniva_grant_shortcut_access() {
 ...
 */
function dyniva_alter_frontpage_view() {
        ...
        'display_options' => [
          ...
          'empty' => [
            'area_text_custom' => [
              ...
              'empty' => TRUE,
              'tokenize' => TRUE,
              'content' => '<p>Welcome to [site:name]. No front page content has been created yet.</p><p>Would you like to <a href="/' . drupal_get_path('profile', 'dyniva') . '/README.md">view the README</a>?</p>',
              'label' => '',
...
function dyniva_modules_installed(array $modules) {
  ...
  if (in_array('dyniva_dev', $modules, TRUE)) {
    Config::forModule('dyniva_media')
      ->optional()
 ...
 */
function dyniva_user_role_presave(RoleInterface $role) {
