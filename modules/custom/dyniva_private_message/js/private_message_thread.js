...
(function ($, _, Drupal, drupalSettings, window) {
  ...
  function getNewMessages() {
    if (!loadingNew) {
      ...
      drupalSettings.dyniva_private_message = drupalSettings.dyniva_private_message||{};

      loadingNew = true;

      threadId = threadWrapper.children(".private-message-thread-default:first,.private-message-thread:first").attr("data-thread-id");

      if(typeof drupalSettings.dyniva_private_message.current_thread_id != 'undefined') {
        threadId = drupalSettings.dyniva_private_message.current_thread_id;
      }
  ...
  function init() {
    ...
    if (!initialized) {
      ...
      var message_count = $(".private-message-full").length;
      ...
      // is active
      if(typeof drupalSettings.dyniva_private_message != 'undefined' && drupalSettings.dyniva_private_message.current_thread_id) {
        $('.private-message-thread-preview').each(function() {
          if(drupalSettings.dyniva_private_message.current_thread_id == $(this).data('thread-id')) {
...
}(jQuery, _, Drupal, drupalSettings, window));
