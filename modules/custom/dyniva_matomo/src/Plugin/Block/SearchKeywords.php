 ...
 *
 * @Block(
 *  id = "dyniva_matomo_search_keywords",
 *  admin_label = @Translation("Matomo search keywords"),
 * )
 */
class SearchKeywords extends MatomoWidgetBase {
  /**
   * {@inheritDoc}
   */
  ...
  public function getApiMethod() {
    return 'Actions.getSiteSearchKeywords';
  }
  /**
   *
   * {@inheritDoc}
